...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sharatacharjee6@gmail.com'       # <--- your Gmail
EMAIL_HOST_PASSWORD = 'rhtd enro tkbm bolu'    # <--- generate App password in Gmail
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # <-- ঠিক path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
